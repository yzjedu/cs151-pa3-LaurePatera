...
- This is great work, but it could use a little bit of update to make it the best work in the class. 
- In the main function, there should be a while loop to ask users whether they want to continue using your program or quit. So there is no 4th option. 
- Error checking or input invalidation for getting the numbers could be a function. 
